...
<body>
                                ...
                                <div class="row align-items-center position-relative">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="hero-slide-thumb">
                                            <img src="assets/images/slider1.webp" width="841" height="832" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    while ($row = $result->fetch_assoc()):
        ...
        $product_image = !empty($img_filename) ? "admin/upload/product/$img_filename" : "assets/images/shop/1.webp";
    ?>
...
* **The Directory Path:** Since your file is `online/index.php` and the image is in `online/admin/upload/product/`, using `admin/upload/product/` as the prefix tells the browser to look inside the admin subfolder.
* **The Grid Structure:** In Bootstrap (which your template seems to use), the `product-item` itself doesn't have width. It needs a "Column" parent (`col-lg-4`) to tell it to take up $1/3$ of the row. Without this, every item takes up 100% width and stacks vertically.
* **XSS Protection:** I added `htmlspecialchars()` around the alt text. This prevents the HTML from breaking if a product name contains a quote (e.g., *Baby's Lotion*).



**Would you like me to help you check if the `image_path` in your database includes the file extension (like .jpg) so we can ensure the images load?** -->
